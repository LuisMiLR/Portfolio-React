    ...
    <section className={styles.container}>
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          Développeur web FullStack Javascript, passionné par les nouvelles
          technologies et leur facultés à améliorer le quotidien des gens avec
          un appétence pour le frontend React js
        </p>
        <p className={styles.description}>

...
<section className={styles.container}>
    <div className={styles.content}>
        <h1 className={styles.title}>Hello, Je suis Luis Miguel Robles</h1>
        <p className={styles.description}> 
        Titulaire du titres Développeur web FullStack Javascript j'ai une appétance forte pour le frontend, j'utilise React et NodeJS. 
